...
def is_valid(plate):
    ...
    # 3) Start with 2 letters
        ...
        return False
    ## The whole plate doesn't have numbers:
    elif not all(letter in string.ascii_uppercase for letter in plate):
        return False
    # 4) Numbers cannot be used in the middle of a plate; they must come at the end
        ...
        return False
    elif plate[-2].isnumeric() and plate[-1] in string.ascii_uppercase:
        return False
